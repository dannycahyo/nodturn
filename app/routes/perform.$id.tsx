...
function performReducer(state: PerformState, action: PerformAction): PerformState {
  switch (action.type) {
    case 'SET_PDF':
    ...
    case 'TOGGLE_GESTURE':
      return { ...state, gestureEnabled: !state.gestureEnabled };
    default:
      return state;
  }
}
...
export default function Perform() {
  ...
  // Start head tracking
  useHeadTracking(detector, state.videoElement, state.gestureEnabled);
  ...
  return (
    <div className="relative">
      ...
      <PageControls
        onToggleGestures={() => dispatch({ type: 'TOGGLE_GESTURE' })}
      />
      <VisualMetronome />
